...
console.log( 'multiplied by 5', fives );


// Iterate through numbers and reduce it by adding them together
const sum = _(numbers).reduce(function (memo, n) {
  return memo + n;
});
console.log( 'sum', sum );
...
console.log( 'e usernames', eUsername );


// Find the first object in people that has the id of 3
const user3 = _(people).findWhere({id: 3});
console.log( 'user with id of 3', user3 );
...
console.log( 'young person', youngPerson );
